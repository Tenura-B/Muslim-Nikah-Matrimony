        ...
        <main className="flex-1 flex items-center justify-center px-8 py-12">
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-5">
              ...
              <button
                type="submit"
                className="mt-2 w-full rounded-lg bg-[#1B6B4A] py-3 text-sm font-semibold text-white hover:bg-[#155a3d] transition-all duration-200 shadow-md hover:shadow-lg"
              >
                Sign In
              </button>
            </form>
            ...
            <button
              type="button"
              className="mt-4 w-full flex items-center justify-center gap-3 rounded-lg border border-gray-200 bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 hover:border-gray-300 transition-all duration-200"
            >
